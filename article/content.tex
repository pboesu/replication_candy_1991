...
\begin{table}
  \small
    \caption{Parameter estimates for the cumulative logit model from \citep{dennis1986stochastic}. This table replicates results presented in the first row of Table~1 of  \citep{kemp1986stochastic}.}
