...
The direct optimisation of the likelihood is sensitive to the choice of initial values~\citep{dennis1986stochastic}. Additional simulations showed that the coefficient of variation for estimates derived from a wide range of initial values was between 6.3\% and 7.1\% whenenver the model converged succesfully. Th and this may explain the difference in the parameter estimates between the different methods. 
